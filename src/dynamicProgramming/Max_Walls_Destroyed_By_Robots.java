...
import java.util.*;
public class Max_Walls_Destroyed_By_Robots {
    ...
    public static void main(String[] args) {
        Max_Walls_Destroyed_By_Robots obj=new Max_Walls_Destroyed_By_Robots();

        int[] robots={4};
        int[] distance={3};
        int[] walls={1,10};
        System.out.println("Maximum Walls Destroyed by  Robots : "+obj.maxWalls(robots,distance,walls));
    }
