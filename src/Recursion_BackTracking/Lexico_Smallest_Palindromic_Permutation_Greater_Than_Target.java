...
public class Lexico_Smallest_Palindromic_Permutation_Greater_Than_Target {
    ...
    public static void main(String[] args) {
        Lexico_Smallest_Palindromic_Permutation_Greater_Than_Target obj = new  Lexico_Smallest_Palindromic_Permutation_Greater_Than_Target();
        System.out.println("Lexicographically smallest permutation greater than target : "+obj.lexPalindromicPermutation("baba","abba"));
