...
//T.C : O(n * log(t))
//S.C : O(n)
public class Smallest_Div_Digit_Product_2 {
    ...
    public static void main(String[] args) {
        Smallest_Div_Digit_Product_2 obj = new Smallest_Div_Digit_Product_2();
        System.out.println("Smallest Number Whose Digits Product Divisible By t is :  "+obj.smallestNumber("1234",256));
    }
