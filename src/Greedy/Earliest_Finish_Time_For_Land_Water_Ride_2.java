package Greedy;
//TC-O(M+N)
//Minimizing total time by independently finding the earliest finish time for each ride category and combining them optimally.

public class Earliest_Finish_Time_For_Land_Water_Ride_2 {
